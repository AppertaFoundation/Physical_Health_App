...
public class EthercisCompositionResponse extends EhrBaseResponse {
    ...
    @Builder
    public EthercisCompositionResponse(String action, Meta meta, String format, String templateId, String composition,
