...
import com.staircase13.apperta.ehrconnector.impls.ehr.ethercis.dto.EhrTemplateListResponseDto;
...
import static com.staircase13.apperta.ehrconnector.impls.ehr.ethercis.EthercisEhrRestConstants.TEMPLATE_ENDPOINT;

@Component
public class EthercisEhrTemplate extends EhrBase {

    private static final Logger LOG = LoggerFactory.getLogger(EthercisEhrTemplate.class);

    private final EthercisEhrConnector ehrConnector;


    @Autowired
    public EthercisEhrTemplate(EthercisEhrConnector ehrConnector) {
