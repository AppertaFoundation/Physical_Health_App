...
public class DeviceEndpointTest {
    ...
    @Test
    public void register() throws AppertaException {
    ...
    @Test
    public void updateReminder() throws AppertaException {
        DeviceNotificationDto dto = DeviceNotificationDto.builder().build();
        when(deviceService.updateOrCreateNotification(dto, USERNAME)).thenReturn(dto);
